...
class EntrepreneursControllerTest < ActionController::TestCase
  ...
  test "should create entrepreneur" do
    assert_difference('Entrepreneur.count') do
      post :create, entrepreneur: { address: @entrepreneur.address, country: @entrepreneur.country, fiscal_number: @entrepreneur.fiscal_number, full_name: @entrepreneur.full_name, town: @entrepreneur.town, zip_code: @entrepreneur.zip_code }
    end
  ...
  test "should update entrepreneur" do
    patch :update, id: @entrepreneur, entrepreneur: { address: @entrepreneur.address, country: @entrepreneur.country, fiscal_number: @entrepreneur.fiscal_number, full_name: @entrepreneur.full_name, town: @entrepreneur.town, zip_code: @entrepreneur.zip_code }
    assert_redirected_to entrepreneur_path(assigns(:entrepreneur))
  end
